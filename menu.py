...
class LoadMenu(object):
    ...
    def load_game(self,index):
        ...
        with open(f'save/stats.txt','r') as savefile:
            ...
            print(Stats.gold_count,Stats.army_count,Stats.terrain_count,Stats.wyb,Stats.player_hex_status,Stats.army_count_bonus,Stats.gold_count_bonus,Stats.turn_count)
